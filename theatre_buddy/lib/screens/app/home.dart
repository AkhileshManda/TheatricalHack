          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("Quick Navigation :", style: TextStyle(fontSize: 25)),
              ),
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("Play of the day :", style: TextStyle(fontSize: 25)),
              ),
              //TODO UPDATE IMAGE
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("Costume of the day:", style: TextStyle(fontSize: 25)),
              ),
